/**
 * CardHolderProfileDOCLITServiceImplServiceStub.java
 *
...
/*
 *  CardHolderProfileDOCLITServiceImplServiceStub java implementation
 */

public class CardHolderProfileDOCLITServiceImplServiceStub extends
	...
	private void populateAxisService() throws org.apache.axis2.AxisFault {
		...
		_service = new org.apache.axis2.description.AxisService(
				"CardHolderProfileDOCLITServiceImplService" + getUniqueSuffix());
	...
	public CardHolderProfileDOCLITServiceImplServiceStub(
	...
	public CardHolderProfileDOCLITServiceImplServiceStub(
		...
		this(configurationContext, "http://localhost:9003/ws/doclit");
	...
	public CardHolderProfileDOCLITServiceImplServiceStub()
		...
		this("http://localhost:9003/ws/doclit");
	 ...
	 * 
	 * @see com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplService#checkProfile
	 * @param checkProfile0
	 */

	public com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileResponseE checkProfile(

			final com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileE checkProfile0)
...

	{
		...
		try {
			...
			_operationClient
					.getOptions()
					.setAction(
							"http://intf.ws.nc.com/CardHolderProfileDOCLITService/checkProfileRequest");
			...
			final java.lang.Object object = fromOM(
					...
					com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileResponseE.class,
					getEnvelopeNamespaces(_returnEnv));

			return (com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileResponseE) object;
	 ...
	 * 
	 * @see com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplService#startcheckProfile
	 * @param checkProfile0
	 */
	public void startcheckProfile(
			...
			final com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceCallbackHandler callback)
				...
				.setCallback(new org.apache.axis2.client.async.AxisCallback() {
					...
					public void onMessage(
						...
						try {
							...
							callback.receiveResultcheckProfile((com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileResponseE) object);
	...
	public static class CheckProfileResponseE implements
			org.apache.axis2.databinding.ADBBean {
		...
		/**
		 * field for CheckProfileResponse
		 */

		protected CheckProfileResponse localCheckProfileResponse;
		 ...
		 */
		public CheckProfileResponse getCheckProfileResponse() {
			return localCheckProfileResponse;
		}
		 ...
		 */
		public void setCheckProfileResponse(final CheckProfileResponse param) {

			this.localCheckProfileResponse = param;
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (localCheckProfileResponse == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"checkProfileResponse cannot be null!");
			}
			localCheckProfileResponse.serialize(MY_QNAME, xmlWriter);
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			// We can safely assume an element has only one type associated with
			// it
			return localCheckProfileResponse.getPullParser(MY_QNAME);
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static CheckProfileResponseE parse(
					final javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				final CheckProfileResponseE object = new CheckProfileResponseE();
					...
					while (!reader.isEndElement()) {
						if (reader.isStartElement()) {
							...
							if (reader.isStartElement()
								...
								object.setCheckProfileResponse(CheckProfileResponse.Factory
										.parse(reader));
	...
	public static class CheckProfileE implements
			org.apache.axis2.databinding.ADBBean {
		...
		/**
		 * field for CheckProfile
		 */

		protected CheckProfile localCheckProfile;
		 ...
		 * @return CheckProfile
		 */
		public CheckProfile getCheckProfile() {
			return localCheckProfile;
		}
		 ...
		 *            CheckProfile
		 */
		public void setCheckProfile(final CheckProfile param) {

			this.localCheckProfile = param;
		...
		public void serialize(final javax.xml.namespace.QName parentQName,
			...
			if (localCheckProfile == null) {
				throw new org.apache.axis2.databinding.ADBException(
						"checkProfile cannot be null!");
			}
			localCheckProfile.serialize(MY_QNAME, xmlWriter);
		...
		public javax.xml.stream.XMLStreamReader getPullParser(
			...
			// We can safely assume an element has only one type associated with
			// it
			return localCheckProfile.getPullParser(MY_QNAME);
		...
		public static class Factory {
			 ...
			 * positioned at the end element of its outer element
			 */
			public static CheckProfileE parse(
					final javax.xml.stream.XMLStreamReader reader)
					throws java.lang.Exception {
				final CheckProfileE object = new CheckProfileE();
					...
					while (!reader.isEndElement()) {
						if (reader.isStartElement()) {
							...
							if (reader.isStartElement()
									&& new javax.xml.namespace.QName(
											"http://intf.ws.nc.com/",
											"checkProfile").equals(reader
											.getName())) {

								object.setCheckProfile(CheckProfile.Factory
										.parse(reader));
	...
	public static class CheckProfileResponse implements
		...
		/*
		 * This type was generated from the piece of schema that had name =
		 * checkProfileResponse Namespace URI = http://intf.ws.nc.com/ Namespace
		 * Prefix = ns1
		 */
	...
	public static class ExtensionMapper {
		...
		public static java.lang.Object getTypeObject(
			...
			if ("http://intf.ws.nc.com/".equals(namespaceURI)
					&& "checkProfileResponse".equals(typeName)) {

				return CheckProfileResponse.Factory.parse(reader);
			...
			if ("http://intf.ws.nc.com/".equals(namespaceURI)
					&& "checkProfile".equals(typeName)) {

				return CheckProfile.Factory.parse(reader);
	...
	public static class CheckProfile implements
		...
		/*
		 * This type was generated from the piece of schema that had name =
		 * checkProfile Namespace URI = http://intf.ws.nc.com/ Namespace Prefix
		 * = ns1
		 */
	...
	private org.apache.axiom.om.OMElement toOM(
			final com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileE param,
			final boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileE.MY_QNAME,
	...
	private org.apache.axiom.om.OMElement toOM(
			final com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileResponseE param,
			final boolean optimizeContent) throws org.apache.axis2.AxisFault {

		try {
			return param
					.getOMElement(
							com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileResponseE.MY_QNAME,
							org.apache.axiom.om.OMAbstractFactory
									.getOMFactory());
		} catch (final org.apache.axis2.databinding.ADBException e) {
			throw org.apache.axis2.AxisFault.makeFault(e);
	...
	private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param,
		...
		try {
			...
			if (com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileE.class
					.equals(type)) {

				return com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());

			}

			if (com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileResponseE.class
					.equals(type)) {

				return com.nc.ws.impl.axis2.CardHolderProfileDOCLITServiceImplServiceStub.CheckProfileResponseE.Factory
						.parse(param.getXMLStreamReaderWithoutCaching());
