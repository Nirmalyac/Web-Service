/**
 * CardHolderProfileRPCLITServiceImplServiceCallbackHandler.java
 *
...
/**
 * CardHolderProfileRPCLITServiceImplServiceCallbackHandler Callback class,
 * Users can extend this class and implement their own receiveResult and
 * receiveError methods.
 */
public abstract class CardHolderProfileRPCLITServiceImplServiceCallbackHandler {
	 ...
	 */
	public CardHolderProfileRPCLITServiceImplServiceCallbackHandler(
	...
	public void receiveResultcheckProfile(
			final com.nc.ws.impl.axis2.CardHolderProfileRPCLITServiceImplServiceStub.CheckProfileResponse result) {
	}
